...
package top.continew.admin.front.config;
...
import top.continew.admin.front.handler.CustomWebSocketHandler;
...
public class WebSocketConfig implements WebSocketConfigurer {
    ...
    @Resource
    private CustomWebSocketHandler myWebSocketHandler;
