...
@Schema(description = "绘图任务详情信息")
public class DrawTaskDetailResp extends BaseDetailResp {
    ...
    @ExcelProperty(value = "任务状态success")
